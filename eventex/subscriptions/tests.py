...
class SubscribeTest(TestCase):
    ...
    def test_csrf(self):
        """html must contain csrfmiddlewaretoken"""
...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Hildebrando Pedroni', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('hilde.pedroni@gmail.com', email.body)
        self.assertIn('19-99759-7552', email.body)
